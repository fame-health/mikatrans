...
<head>
    ...
    <title>TravelBus - Layanan Bus & Travel Terpercaya</title>
...
<body class="bg-gray-50 text-gray-800 overflow-x-hidden">
    ...
    <nav class="bg-white/95 backdrop-blur-md shadow-lg fixed w-full top-0 z-50 border-b border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div id="mobile-menu" class="hidden lg:hidden pb-4 space-y-1">
                <a href="/home" class="block py-2 text-sm text-primary font-semibold bg-accent/10 px-3 rounded-lg">Home</a>
                ...
                <div class="space-y-5">
                    <div class="inline-block">
                        <span class="bg-accent/20 text-accent px-3 py-1.5 rounded-full text-xs font-semibold backdrop-blur-sm border border-accent/30">
                            ⭐ #1 Travel Service in Indonesia
                        </span>
                    </div>
                    <h1 class="text-4xl lg:text-5xl font-bold leading-tight">
                        Perjalanan <span class="gradient-accent bg-clip-text text-transparent">Nyaman</span> Dimulai Dari Sini
                    </h1>
                    <p class="text-base text-gray-300 leading-relaxed">
                        Nikmati perjalanan yang aman, nyaman, dan terpercaya bersama TravelBus. Armada modern dengan layanan berkelas internasional.
                    </p>
                    <div class="flex flex-wrap gap-3">
                        <button class="gradient-accent shine-effect text-primary-dark text-sm font-bold px-6 py-3 rounded-xl shadow-2xl hover:shadow-accent/50 transform hover:scale-105 transition-all duration-300">
                            <i class="fas fa-ticket-alt mr-1.5"></i>
                            Pesan Tiket Sekarang
                        </button>
                        <button class="glass-effect text-white text-sm font-bold px-6 py-3 rounded-xl hover:bg-white/20 transition-all duration-300">
                    ...
                    <div class="grid grid-cols-3 gap-5 pt-4">
                        <div class="text-center">
                            ...
                            <div class="text-xs text-gray-400 mt-0.5">Rute Tersedia</div>
                        </div>
                        <div class="text-center">
                            <div class="text-3xl font-bold gradient-accent bg-clip-text text-transparent">50K+</div>
                            <div class="text-xs text-gray-400 mt-0.5">Penumpang</div>
                        </div>
                        <div class="text-center">
                            <div class="text-3xl font-bold gradient-accent bg-clip-text text-transparent">4.9</div>
    ...
    <div class="absolute -bottom-6 -left-6 gradient-accent p-5 rounded-2xl shadow-2xl hover:scale-105 transition-transform duration-300">
        <div class="text-xs font-semibold text-primary-dark">Promo Spesial Hari Ini</div>
        <div class="text-2xl font-bold text-primary-dark mt-0.5">Diskon 25%</div>
    </div>
</div>
    ...
    <!-- Jadwal Bus Section -->
<section id="layanan" class="py-20 bg-gray-50/50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="space-y-16">
            ...
            <div class="grid lg:grid-cols-12 gap-12 items-center">
                <div class="lg:col-span-5 relative group order-2 lg:order-1">
                    ...
                    <div class="relative z-10 overflow-hidden rounded-3xl shadow-2xl border-8 border-white">
                        <img src="{{ asset('image/bus.png') }}" alt="Bus Pariwisata Mika Trans" class="w-full h-auto object-cover transform group-hover:scale-110 transition duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-primary/80 via-transparent to-transparent flex items-end p-8">
                            <div>
                                <p class="text-accent font-bold text-lg">Bus Pariwisata</p>
                                <p class="text-white text-sm opacity-90">Kenyamanan Berwisata Grup</p>
                            </div>
                        </div>
                    </div>
                    <div class="absolute -bottom-6 -left-6 z-20 bg-white p-5 rounded-2xl shadow-xl border border-gray-100 hidden md:block animate-bounce-slow">
                        <div class="flex items-center space-x-3">
                            <div class="bg-accent/10 p-2 rounded-lg text-accent-dark">
                                <i class="fas fa-bus text-xl"></i>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500 font-medium">Pilihan Armada</p>
                                <p class="text-sm font-bold text-primary">31 & 50 Seat</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-7 order-1 lg:order-2">
                    <h3 class="text-3xl font-bold text-primary mb-6 flex items-center">
                        <span class="w-12 h-12 gradient-accent rounded-xl flex items-center justify-center mr-4 text-white shadow-lg">
                    ...
                    <div class="grid md:grid-cols-2 gap-4 mb-8">
                        <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex items-center space-x-4 hover:border-accent transition-all">
                            <div class="bg-orange-50 text-orange-600 p-3 rounded-xl"><i class="fas fa-users-viewfinder"></i></div>
                            <span class="font-bold text-gray-700 text-sm">Family Gathering</span>
                        </div>
                        <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex items-center space-x-4 hover:border-accent transition-all">
                            <div class="bg-blue-50 text-blue-600 p-3 rounded-xl"><i class="fas fa-graduation-cap"></i></div>
                            <span class="font-bold text-gray-700 text-sm">Study Tour</span>
                        </div>
                        <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex items-center space-x-4 hover:border-accent transition-all">
                            <div class="bg-green-50 text-green-600 p-3 rounded-xl"><i class="fas fa-mosque"></i></div>
                            <span class="font-bold text-gray-700 text-sm">Perjalanan Ziarah</span>
                        </div>
                        <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex items-center space-x-4 hover:border-accent transition-all">
                            <div class="bg-purple-50 text-purple-600 p-3 rounded-xl"><i class="fas fa-umbrella-beach"></i></div>
                            <span class="font-bold text-gray-700 text-sm">Tour Wisata & DLL</span>
                        </div>
                    </div>

                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="https://wa.me/+6282288023332" class="flex-1 shine-effect inline-flex items-center justify-center gradient-dark text-white font-bold py-4 rounded-2xl hover:shadow-2xl transition-all">
                            <i class="fab fa-whatsapp text-xl mr-3"></i> Sewa Bus Pariwisata
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-12 gap-12 items-center">
                <div class="lg:col-span-7">
                    <h3 class="text-3xl font-bold text-primary mb-2 flex items-center">
                        <span class="w-12 h-12 gradient-accent rounded-xl flex items-center justify-center mr-4 text-white shadow-lg">
                            <i class="fas fa-route"></i>
                        </span>
                        Travel Executive
                    </h3>
                    <p class="text-gray-500 mb-8 ml-16 font-medium italic">Pekanbaru — Tembilahan (PP)</p>

                    <div class="grid md:grid-cols-2 gap-4 mb-8">
                        <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 relative overflow-hidden group hover:border-accent transition-all">
                            <div class="absolute top-0 right-0 p-3 opacity-10 group-hover:scale-125 transition-transform"><i class="fas fa-sun text-4xl"></i></div>
                            <h4 class="text-sm font-bold text-gray-400 uppercase">Sesi Pagi</h4>
                            <p class="text-3xl font-black text-primary mt-1">10.00 <span class="text-sm font-medium text-gray-500">WIB</span></p>
                        </div>
                        <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 relative overflow-hidden group hover:border-accent transition-all">
                            <div class="absolute top-0 right-0 p-3 opacity-10 group-hover:scale-125 transition-transform"><i class="fas fa-moon text-4xl"></i></div>
                            <h4 class="text-sm font-bold text-gray-400 uppercase">Sesi Malam</h4>
                            <p class="text-3xl font-black text-primary mt-1">21.00 <span class="text-sm font-medium text-gray-500">WIB</span></p>
                        </div>
                    </div>

                    <div class="space-y-3 mb-8">
                        <div class="flex items-center text-gray-700 font-medium"><i class="fas fa-check-circle text-accent mr-3"></i> Layanan Door-to-Door (Jemput di Alamat)</div>
                        <div class="flex items-center text-gray-700 font-medium"><i class="fas fa-check-circle text-accent mr-3"></i> Pengiriman Paket Kilat 1 Hari Sampai</div>
                    </div>

                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="https://wa.me/6281399441555" class="flex-1 shine-effect inline-flex items-center justify-center gradient-accent text-primary-dark font-bold py-4 rounded-2xl hover:shadow-2xl transition-all">
                            <i class="fas fa-ticket-alt mr-3"></i> Pesan Tiket Travel
                        </a>
                    </div>
                </div>
                ...
                <div class="lg:col-span-5 relative group">
                    <div class="absolute -inset-4 gradient-accent opacity-20 blur-2xl rounded-full group-hover:opacity-30 transition duration-500"></div>
                    <div class="relative z-10 overflow-hidden rounded-3xl shadow-2xl border-8 border-white">
                        <img src="{{ asset('image/travel.png') }}" alt="Travel Mika Trans" class="w-full h-auto object-cover transform group-hover:scale-110 transition duration-700">
                    </div>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div class="order-2 lg:order-1">
                    ...
                    <h2 class="text-3xl font-bold text-primary mb-4 mt-1">
                        Lebih Dari Sekadar <span class="gradient-accent bg-clip-text text-transparent">Transportasi</span>
                    </h2>
<p class="text-gray-600 text-sm mb-4 leading-relaxed">
    PT MIKATRANS PEKANBARU adalah penyedia layanan transportasi bus pariwisata dan travel yang berpusat di Riau, berkomitmen menghadirkan standar keamanan serta kenyamanan premium bagi setiap perjalanan Anda.
</p>
<p class="text-gray-600 text-sm mb-6 leading-relaxed">
    Didukung oleh armada terbaru yang terawat serta pengemudi profesional yang berpengalaman di lintas Sumatra dan Jawa, kami siap menjadi mitra terpercaya untuk kebutuhan perjalanan personal, keluarga, hingga instansi.
</p>

                    <div class="grid grid-cols-2 gap-4 mb-6">
                        <div class="bg-linear-to-br from-primary/5 to-primary/10 p-4 rounded-xl hover-lift border border-primary/10 transition-transform duration-300 hover:-translate-y-1">
                            <div class="bg-primary text-accent p-3 rounded-lg inline-block mb-3">
                                <i class="fas fa-shield-alt text-xl"></i>
                            </div>
                            <h4 class="font-bold text-primary text-sm mb-1">Keamanan Terjamin</h4>
                            <p class="text-xs text-gray-600">Armada terawat & asuransi lengkap untuk kenyamanan Anda</p>
                        </div>
                        <div class="bg-linear-to-br from-accent/5 to-accent/10 p-4 rounded-xl hover-lift border border-accent/10 transition-transform duration-300 hover:-translate-y-1">
                            <div class="gradient-accent text-primary-dark p-3 rounded-lg inline-block mb-3">
                                <i class="fas fa-clock text-xl"></i>
                            </div>
                            <h4 class="font-bold text-primary text-sm mb-1">Tepat Waktu</h4>
                            <p class="text-xs text-gray-600">Jadwal teratur & on-time guarantee setiap hari</p>
                        </div>
                        <div class="bg-linear-to-br from-accent/5 to-accent/10 p-4 rounded-xl hover-lift border border-accent/10 transition-transform duration-300 hover:-translate-y-1">
                            <div class="gradient-accent text-primary-dark p-3 rounded-lg inline-block mb-3">
                                <i class="fas fa-couch text-xl"></i>
                            </div>
                            <h4 class="font-bold text-primary text-sm mb-1">Kenyamanan Premium</h4>
                            <p class="text-xs text-gray-600">Kursi empuk reclining & AC sejuk di setiap bus</p>
                        </div>
                        <div class="bg-linear-to-br from-primary/5 to-primary/10 p-4 rounded-xl hover-lift border border-primary/10 transition-transform duration-300 hover:-translate-y-1">
                            <div class="bg-primary text-accent p-3 rounded-lg inline-block mb-3">
                                <i class="fas fa-tags text-xl"></i>
                            </div>
                            <h4 class="font-bold text-primary text-sm mb-1">Harga Terjangkau</h4>
                            <p class="text-xs text-gray-600">Harga bersaing dengan promo menarik setiap bulan</p>
                        </div>
                    </div>
                </div>
...
<div class="relative order-1 lg:order-2">
    ...
    <div class="absolute -bottom-8 -left-8 gradient-dark text-white p-6 rounded-2xl shadow-2xl z-20 hover:scale-105 transition-transform duration-300">
        <div class="text-4xl font-bold gradient-accent bg-clip-text text-transparent">15+</div>
        <div class="text-base mt-1">Tahun Pengalaman</div>
        <div class="text-xs text-gray-400 mt-0.5">Melayani Indonesia</div>
    </div>
</div>
